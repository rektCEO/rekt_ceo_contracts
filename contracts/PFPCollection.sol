...
contract PFPCollection is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl, ReentrancyGuard, IERC2981 {
    ...
    // Get the remaining supply and return The number of NFTs that can still be minted
    ...
    //Get split royalty information for a token
    // return adminReceiver to receive royalties
    // return creatorReceiver to receive royalties
    ...
    //Get the creator of a specific token and return The address of the creator
